...
class SpriteWithTextWindow(WorldSprite):
    ...
    def draw(self, screen, camera):
        ...
        self.text_window.set_position( (sprite_rect[0]+sprite_rect[2]//2 - self.text_window.screen_wh[0]//2, sprite_rect[1] - self.text_window.screen_wh[1]-self.text_window_offset_y) )
